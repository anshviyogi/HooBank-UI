...
const Hero = () =>(
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our teams of experts uses a methodology to identify the credit cards most likly to fit your needs. We examine annual percentage rates, annual fees.</p>
    </div>
